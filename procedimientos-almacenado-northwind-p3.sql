...
--- Soluci�n A. usando LIKE (como, parecido)
...
--- Soluci�n B. usando = (igual)(exactamente igual)
...
---2.1 Soluci�n A (usando par�metro de salida)
...
---2.1 Soluci�n B (usando variable de retorno)
...
--Ejemplo cliente con c�digo ALFKI
-- Con par�metro de salida
...
--4.	Realizar una base de datos similar a Northwind, pero que los nombre de tablas, campos y registros est�n en castellano.
